...
echo access "https://id.twitch.tv/oauth2/authorize?client_id=${TWARK_CLIENT_ID}&redirect_uri=http://localhost:8000/twark/&response_type=code&scope=chat:read+chat:edit+channel:read:redemptions"
